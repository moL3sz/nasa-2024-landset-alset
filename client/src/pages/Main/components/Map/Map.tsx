...
import {setPathDate, setView} from "../../../../store/map/map.slice.ts";
            ...
            <MapContainer
...

                {
                    targets.map((target, index) => {
                        console.log(target)
                        return <Marker key={index} position={target.coordinate}>
                            <Popup>
                ...
                <Control position={"topleft"} prepend={false}>
                    <Button rounded={true} icon={view === "satellite" ? "pi pi-globe" : "pi pi-map"} onClick={(e) => {
                        dispatch(setView())
                    }}/>
                </Control>
                <SatellitePathLayer/>
